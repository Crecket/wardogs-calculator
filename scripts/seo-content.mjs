export const SEO_PAGE_CONTENT = {
    en: {
        ...
        description: 'Free WARDOGS artillery calculator for Mortar and SPH-2 with Bakurani, Ozeti and Zestafona maps, Terrain3D MIL correction, contours and tactical tools.',
        heading: 'About this calculator',
        intro: 'WARDOGS Artillery Calculator is a free, open-source community tool for mortar and SPH-2 firing solutions. It includes interactive tactical maps for Bakurani, Ozeti and Zestafona, coordinate-based targeting, distance, azimuth and MIL calculations, terrain contours, and experimental Terrain3D MIL correction for SPH-2 where supported.',
        ...
        cluster: {
            ...
            sections: [
                ...
                },
                {
                    id: 'how-to-use',
                    heading: 'How to use',
                    body: 'Select Bakurani, Ozeti, Zestafona or a custom map, choose Mortar or SPH-2, place the artillery position and target, then read distance, azimuth and MIL. For SPH-2 on supported maps, experimental Terrain3D correction can be enabled manually to compare a SAFE terrain-adjusted candidate with the normal firing-table value.'
                }
            ]
        },
        faq: [
    ...
    ru: {
        description: 'Бесплатный калькулятор WARDOGS для Mortar и SPH-2 с картами Bakurani, Ozeti и Zestafona, контурами и экспериментальной Terrain3D-коррекцией MIL.',
        heading: 'О калькуляторе',
        intro: 'WARDOGS Artillery Calculator — бесплатный open-source инструмент сообщества для расчёта миномёта и SPH-2. Он включает интерактивные тактические карты Bakurani, Ozeti и Zestafona, расчёт дистанции, азимута и MIL, контуры рельефа и экспериментальную Terrain3D-коррекцию MIL для SPH-2 там, где она поддерживается.',
    ...
    uk: {
        description: 'Безкоштовний калькулятор WARDOGS для Mortar і SPH-2 з мапами Bakurani, Ozeti та Zestafona, контурами й експериментальною Terrain3D-корекцією MIL.',
        heading: 'Про калькулятор',
        intro: 'WARDOGS Artillery Calculator — безкоштовний open-source інструмент спільноти для розрахунків міномета та SPH-2. Він містить інтерактивні тактичні мапи Bakurani, Ozeti та Zestafona, розрахунок дистанції, азимута та MIL, контури рельєфу й експериментальну Terrain3D-корекцію MIL для SPH-2 там, де вона підтримується.',
    ...
    de: {
        description: 'Kostenloser WARDOGS Rechner für Mortar und SPH-2 mit Bakurani-, Ozeti- und Zestafona-Karten, Höhenlinien und experimenteller Terrain3D-MIL-Korrektur.',
        heading: 'Über diesen Rechner',
        intro: 'Der WARDOGS Artillery Calculator ist ein kostenloses Open-Source-Community-Tool für Mörser- und SPH-2-Feuerlösungen. Er bietet interaktive taktische Karten für Bakurani, Ozeti und Zestafona, Distanz-, Azimut- und MIL-Berechnung, Höhenlinien und eine experimentelle Terrain3D-MIL-Korrektur für SPH-2 auf unterstütztem Gelände.',
    ...
    es: {
        description: 'Calculadora WARDOGS gratuita para Mortar y SPH-2 con mapas Bakurani, Ozeti y Zestafona, curvas de nivel y corrección MIL Terrain3D experimental.',
        heading: 'Acerca de la calculadora',
        intro: 'WARDOGS Artillery Calculator es una herramienta comunitaria gratuita y de código abierto para soluciones de tiro de mortero y SPH-2. Incluye mapas tácticos interactivos de Bakurani, Ozeti y Zestafona, cálculos de distancia, azimut y MIL, curvas de nivel y una corrección MIL Terrain3D experimental para SPH-2 en terreno compatible.',
    ...
    pl: {
        description: 'Darmowy kalkulator WARDOGS dla Mortar i SPH-2 z mapami Bakurani, Ozeti i Zestafona, poziomicami oraz eksperymentalną korektą MIL Terrain3D.',
        heading: 'O kalkulatorze',
        intro: 'WARDOGS Artillery Calculator to darmowe narzędzie open source społeczności do rozwiązań ogniowych moździerza i SPH-2. Zawiera interaktywne mapy taktyczne Bakurani, Ozeti i Zestafona, obliczenia dystansu, azymutu i MIL, poziomice oraz eksperymentalną korektę MIL Terrain3D dla SPH-2 na obsługiwanym terenie.',
    ...
    ko: {
        description: 'SPH-2와 Mortar용 무료 WARDOGS 포병 계산기. Bakurani, Ozeti, Zestafona 지도와 등고선, 실험적 Terrain3D MIL 보정 및 전술 도구를 제공합니다.',
        heading: '계산기 소개',
        intro: 'WARDOGS Artillery Calculator는 박격포와 SPH-2 사격 제원을 계산하기 위한 무료 오픈 소스 커뮤니티 도구입니다. Bakurani, Ozeti, Zestafona 인터랙티브 전술 지도, 거리·방위각·MIL 계산, 지형 등고선과 지원되는 지형에서의 실험적 SPH-2 Terrain3D MIL 보정을 제공합니다.',
    ...
    pt: {
        description: 'Calculadora WARDOGS gratuita para Mortar e SPH-2, com mapas Bakurani, Ozeti e Zestafona, curvas de nível e correção MIL Terrain3D experimental.',
        heading: 'Sobre a calculadora',
        intro: 'WARDOGS Artillery Calculator é uma ferramenta comunitária gratuita e open source para soluções de tiro de morteiro e SPH-2. Inclui mapas táticos interativos de Bakurani, Ozeti e Zestafona, cálculos de distância, azimute e MIL, curvas de nível e correção MIL Terrain3D experimental para SPH-2 em terreno suportado.',
    ...
    ja: {
        description: 'SPH-2と迫撃砲に対応した無料のWARDOGS砲兵用弾道計算機。Bakurani、Ozeti、Zestafonaのマップ、等高線、実験的なTerrain3D MIL補正、戦術ツールを備えています。',
        heading: 'この計算機について',
        intro: 'WARDOGS Artillery Calculatorは、迫撃砲とSPH-2の射撃諸元を算出するための無料・オープンソースのコミュニティツールです。Bakurani、Ozeti、Zestafonaのインタラクティブ戦術マップ、座標による目標指定、距離・方位角・MILの計算、地形の等高線、対応する地形での実験的なSPH-2向けTerrain3D MIL補正を提供します。',
    ...
    cat: {
        description: 'Free WARDOGS arty meowculator for Mortar and SPH-2 with Bakurani, Ozeti and Zestafona meowps, contour paws and Terrain3D MIL meowgic.',
        heading: 'About the meowculator',
        intro: 'WARDOGS Artillery Calculator is a free open-source community meowculator for mortar and SPH-2 firing solutions. It includes interactive Bakurani, Ozeti and Zestafona tactical meowps, distance, azimuth and MIL math, contour paws and experimental Terrain3D MIL meowgic for supported SPH-2 shots.',
